  ...
  return (
    <div>
      ...
      <section className="p-8 text-center">
        <h2 className="text-3xl font-bold mb-4">Welcome to Dowell Maritime & Oil Resources Ltd</h2>
        <p className="mb-6">
      ...
      <p className="text-lg">We provide world-class maritime logistics, shipping, and port services.</p>
      </section>
    </div>
  );
}
